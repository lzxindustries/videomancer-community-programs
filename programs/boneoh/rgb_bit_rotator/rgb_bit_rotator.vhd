...
begin
    ...
    -- Output Multiplexing
    --------------------------------------------------------------------------------
    s_io_align_in.y <= std_logic_vector(s_yuv_out_y) when s_bypass_enable = '0'
                  else s_y_delayed;
    s_io_align_in.u <= std_logic_vector(s_yuv_out_u) when s_bypass_enable = '0'
                  else s_u_delayed;
    s_io_align_in.v <= std_logic_vector(s_yuv_out_v) when s_bypass_enable = '0'
                  else s_v_delayed;
